...
if __name__ == "__main__":
    ...
    # ctrl4.beta = 10.0
    # ctrl5.beta = 10.0
    # ctrl1.c_level = terminal_set.calculate_c(ctrl1, x_target)
    # ctrl2.c_level = terminal_set.calculate_c(ctrl2, x_target)
    # ctrl3.c_level = terminal_set.calculate_c(ctrl3, x_target)
    (x_target, u_target) = ctrl4.computeOTS(y_target, np.zeros(ctrl4.dim.nd))
    
    ctrl4.c_level = terminal_set.calculate_c(ctrl4, x_target)
    ctrl5.c_level = terminal_set.calculate_c(ctrl5, x_target)
    ctrl6.c_level = terminal_set.calculate_c(ctrl6, x_target)
    ...
    #     error = np.sqrt(np.square(y_target[0]-states[0, :])
    ...
    # plt.suptitle("Effect of horizon N on tracking error of position (with Terminal cost)")
